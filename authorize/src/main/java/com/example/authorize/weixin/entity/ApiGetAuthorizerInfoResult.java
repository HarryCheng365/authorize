...
public class ApiGetAuthorizerInfoResult extends BaseResult {
	...
	public static class Authorizer_info {
		...
		public static class Business_info {
			...
			public String  toString(){
				...
				jsonObject.put("open_store",open_store);
				jsonObject.put("open_scan",open_scan);
				jsonObject.put("open_pay",open_pay);
				jsonObject.put("open_card",open_card);
				jsonObject.put("open_shake",open_shake);
	...
	public static class Authorization_info {
		...
		public String funcInfoListToString(){
			JSONArray jsonArray =new JSONArray();
			for(FuncInfo funcInfo:func_info){
				jsonArray.add(funcInfo.getFuncscope_category().toString());
			}
