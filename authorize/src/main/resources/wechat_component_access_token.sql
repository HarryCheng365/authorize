...
create table if NOT EXISTS `wechat_user_account_info` (
  ...
  `head_img` varchar(256) default null comment '公众号主体头像http://wx.qlogo.cn/mmopen/GPy',
  ...
  `qrCode_url` varchar(256) default null comment '二维码图片的URL，开发者最好自行也进行保存',
  `func_info` varchar(512) default null comment'公众号授权给开发者的权限集列表',
  PRIMARY KEY (`authorizerAppId`)
  ) engine=innodb default charset=utf8;
